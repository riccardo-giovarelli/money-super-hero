...
const TransactionsNew = () => {
    ...
    return (
        <Container maxWidth="lg">
            <form onSubmit={handleSubmit}>
                <Grid container spacing={2}>
                    ...
                    <Grid size={{xs: 12, md: 6}}>
                        ...
                        >
                            <FormLabel
                                id="direction-radio-buttons-group-label">{t('transactions.add_transaction.direction.label')}</FormLabel>
                            <RadioGroup
                                row
                                id="direction"
                                name="direction"
                            ...
                            >
                                <FormControlLabel value="IN" control={<Radio required/>}
                                                  label={t('transactions.add_transaction.direction.in')}/>
                                <FormControlLabel value="OUT" control={<Radio required/>}
                    ...
                    <Grid size={{xs: 12, md: 6}}>
                        ...
                        <FormControl fullWidth>
                            <InputLabel
                                id="category-select-name-label">{t('transactions.add_transaction.category.label')} *</InputLabel>
                            <Select
            ...
            {message && (
                <Alert sx={{marginTop: 3}} severity={message.type} onClose={() => {
                    setMessage(null);
                }}>
                    {message.text}
                </Alert>
